...
7. To allow "transparency agents" to report undisclosed COI, the Council must provide a publicly-accessible & free-to-submit `COI Reporting` form:
...
8. To incentivise reporters of undisclosed COI, the Council must freeze its compensation to the subject member until relevant submissions are verified, and redirect it to the reporter with a proposal that, when passed, confirms the veridicity of the report.
...
## Additional info by the proposer
### Rationale
...
#### On-chain text proposal
**Title:** COI Disclosure & Acknowledgement 
**Description:**
I hereby disclose my potential conflict of interests according to our [policy](URL):
|COI Definition|Entity|Period|
|-|-|-|
1.1 Compensation from|[Siemens](https://www.siemens.com/)|indefinite|
1.1 Compensation from|[Neutron DAO]()|Jan--June 2024|
1.2 Rights on receiver|[Chaintools validator](https://www.mintscan.io/juno/validators/junovaloper1dru5985k4n5q369rxeqfdsjl8ezutch8mc6nx9)|indefinite|
1.3 Significant share of|[WOSMO DAO](https://daodao.zone/dao/osmo1elw4psm8sddcvu8fsdx3hs0zkctcdzwu8qspuxzthepc6ev55c8qvp08u6/treasury)|indefinite|
